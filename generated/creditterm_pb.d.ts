...
export class SaveCreditTermRequestProto extends jspb.Message { 
    getTenantId(): string;
    setTenantId(value: string): SaveCreditTermRequestProto;

    hasCreditTerm(): boolean;
    clearCreditTerm(): void;
    getCreditTerm(): CreditTermProto | undefined;
    setCreditTerm(value?: CreditTermProto): SaveCreditTermRequestProto;

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): SaveCreditTermRequestProto.AsObject;
    static toObject(includeInstance: boolean, msg: SaveCreditTermRequestProto): SaveCreditTermRequestProto.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: SaveCreditTermRequestProto, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): SaveCreditTermRequestProto;
    static deserializeBinaryFromReader(message: SaveCreditTermRequestProto, reader: jspb.BinaryReader): SaveCreditTermRequestProto;
}

export namespace SaveCreditTermRequestProto {
    export type AsObject = {
        tenantId: string,
        creditTerm?: CreditTermProto.AsObject,
    }
...
export class SaveCreditTermResponseProto extends jspb.Message { 

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): SaveCreditTermResponseProto.AsObject;
    static toObject(includeInstance: boolean, msg: SaveCreditTermResponseProto): SaveCreditTermResponseProto.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: SaveCreditTermResponseProto, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): SaveCreditTermResponseProto;
    static deserializeBinaryFromReader(message: SaveCreditTermResponseProto, reader: jspb.BinaryReader): SaveCreditTermResponseProto;
}

export namespace SaveCreditTermResponseProto {
    export type AsObject = {
    }
}

export class SetCreditTermIsHiddenRequestProto extends jspb.Message { 
    getTenantId(): string;
    setTenantId(value: string): SetCreditTermIsHiddenRequestProto;
    getCreditTermId(): string;
    setCreditTermId(value: string): SetCreditTermIsHiddenRequestProto;
    getHide(): boolean;
    setHide(value: boolean): SetCreditTermIsHiddenRequestProto;

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): SetCreditTermIsHiddenRequestProto.AsObject;
    static toObject(includeInstance: boolean, msg: SetCreditTermIsHiddenRequestProto): SetCreditTermIsHiddenRequestProto.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: SetCreditTermIsHiddenRequestProto, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): SetCreditTermIsHiddenRequestProto;
    static deserializeBinaryFromReader(message: SetCreditTermIsHiddenRequestProto, reader: jspb.BinaryReader): SetCreditTermIsHiddenRequestProto;
}

export namespace SetCreditTermIsHiddenRequestProto {
    export type AsObject = {
        tenantId: string,
        creditTermId: string,
        hide: boolean,
...
export class SetCreditTermIsHiddenResponseProto extends jspb.Message { 

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): SetCreditTermIsHiddenResponseProto.AsObject;
    static toObject(includeInstance: boolean, msg: SetCreditTermIsHiddenResponseProto): SetCreditTermIsHiddenResponseProto.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: SetCreditTermIsHiddenResponseProto, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): SetCreditTermIsHiddenResponseProto;
    static deserializeBinaryFromReader(message: SetCreditTermIsHiddenResponseProto, reader: jspb.BinaryReader): SetCreditTermIsHiddenResponseProto;
}

export namespace SetCreditTermIsHiddenResponseProto {
    export type AsObject = {
    }
}
