...
export class SaveUnitOfMeasureRequestProto extends jspb.Message { 
    getTenantId(): string;
    setTenantId(value: string): SaveUnitOfMeasureRequestProto;

    hasUnitOfMeasure(): boolean;
    clearUnitOfMeasure(): void;
    getUnitOfMeasure(): UnitOfMeasureProto | undefined;
    setUnitOfMeasure(value?: UnitOfMeasureProto): SaveUnitOfMeasureRequestProto;

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): SaveUnitOfMeasureRequestProto.AsObject;
    static toObject(includeInstance: boolean, msg: SaveUnitOfMeasureRequestProto): SaveUnitOfMeasureRequestProto.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: SaveUnitOfMeasureRequestProto, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): SaveUnitOfMeasureRequestProto;
    static deserializeBinaryFromReader(message: SaveUnitOfMeasureRequestProto, reader: jspb.BinaryReader): SaveUnitOfMeasureRequestProto;
}

export namespace SaveUnitOfMeasureRequestProto {
    export type AsObject = {
        tenantId: string,
        unitOfMeasure?: UnitOfMeasureProto.AsObject,
    }
...
export class SaveUnitOfMeasureResponseProto extends jspb.Message { 

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): SaveUnitOfMeasureResponseProto.AsObject;
    static toObject(includeInstance: boolean, msg: SaveUnitOfMeasureResponseProto): SaveUnitOfMeasureResponseProto.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: SaveUnitOfMeasureResponseProto, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): SaveUnitOfMeasureResponseProto;
    static deserializeBinaryFromReader(message: SaveUnitOfMeasureResponseProto, reader: jspb.BinaryReader): SaveUnitOfMeasureResponseProto;
}

export namespace SaveUnitOfMeasureResponseProto {
    export type AsObject = {
    }
}

export class SetUnitOfMeasureIsHiddenRequestProto extends jspb.Message { 
    getTenantId(): string;
    setTenantId(value: string): SetUnitOfMeasureIsHiddenRequestProto;
    getUnitOfMeasureId(): string;
    setUnitOfMeasureId(value: string): SetUnitOfMeasureIsHiddenRequestProto;
    getHide(): boolean;
    setHide(value: boolean): SetUnitOfMeasureIsHiddenRequestProto;

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): SetUnitOfMeasureIsHiddenRequestProto.AsObject;
    static toObject(includeInstance: boolean, msg: SetUnitOfMeasureIsHiddenRequestProto): SetUnitOfMeasureIsHiddenRequestProto.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: SetUnitOfMeasureIsHiddenRequestProto, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): SetUnitOfMeasureIsHiddenRequestProto;
    static deserializeBinaryFromReader(message: SetUnitOfMeasureIsHiddenRequestProto, reader: jspb.BinaryReader): SetUnitOfMeasureIsHiddenRequestProto;
}

export namespace SetUnitOfMeasureIsHiddenRequestProto {
    export type AsObject = {
        tenantId: string,
        unitOfMeasureId: string,
        hide: boolean,
...
export class SetUnitOfMeasureIsHiddenResponseProto extends jspb.Message { 

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): SetUnitOfMeasureIsHiddenResponseProto.AsObject;
    static toObject(includeInstance: boolean, msg: SetUnitOfMeasureIsHiddenResponseProto): SetUnitOfMeasureIsHiddenResponseProto.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: SetUnitOfMeasureIsHiddenResponseProto, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): SetUnitOfMeasureIsHiddenResponseProto;
    static deserializeBinaryFromReader(message: SetUnitOfMeasureIsHiddenResponseProto, reader: jspb.BinaryReader): SetUnitOfMeasureIsHiddenResponseProto;
}

export namespace SetUnitOfMeasureIsHiddenResponseProto {
    export type AsObject = {
    }
}
