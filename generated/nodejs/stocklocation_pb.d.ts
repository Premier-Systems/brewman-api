...
export class SaveStockLocationsRequestProto extends jspb.Message { 
    getTenantId(): string;
    setTenantId(value: string): SaveStockLocationsRequestProto;
    clearStockLocationsList(): void;
    getStockLocationsList(): Array<StockLocationProto>;
    setStockLocationsList(value: Array<StockLocationProto>): SaveStockLocationsRequestProto;
    addStockLocations(value?: StockLocationProto, index?: number): StockLocationProto;

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): SaveStockLocationsRequestProto.AsObject;
    static toObject(includeInstance: boolean, msg: SaveStockLocationsRequestProto): SaveStockLocationsRequestProto.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: SaveStockLocationsRequestProto, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): SaveStockLocationsRequestProto;
    static deserializeBinaryFromReader(message: SaveStockLocationsRequestProto, reader: jspb.BinaryReader): SaveStockLocationsRequestProto;
}

export namespace SaveStockLocationsRequestProto {
    export type AsObject = {
        tenantId: string,
        stockLocationsList: Array<StockLocationProto.AsObject>,
    }
...
export class SaveStockLocationsResponseProto extends jspb.Message { 

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): SaveStockLocationsResponseProto.AsObject;
    static toObject(includeInstance: boolean, msg: SaveStockLocationsResponseProto): SaveStockLocationsResponseProto.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: SaveStockLocationsResponseProto, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): SaveStockLocationsResponseProto;
    static deserializeBinaryFromReader(message: SaveStockLocationsResponseProto, reader: jspb.BinaryReader): SaveStockLocationsResponseProto;
}

export namespace SaveStockLocationsResponseProto {
    export type AsObject = {
    }
}

export class SetStockLocationIsHiddenRequestProto extends jspb.Message { 
    getTenantId(): string;
    setTenantId(value: string): SetStockLocationIsHiddenRequestProto;
    getStockLocationId(): string;
    setStockLocationId(value: string): SetStockLocationIsHiddenRequestProto;
    getHide(): boolean;
    setHide(value: boolean): SetStockLocationIsHiddenRequestProto;

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): SetStockLocationIsHiddenRequestProto.AsObject;
    static toObject(includeInstance: boolean, msg: SetStockLocationIsHiddenRequestProto): SetStockLocationIsHiddenRequestProto.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: SetStockLocationIsHiddenRequestProto, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): SetStockLocationIsHiddenRequestProto;
    static deserializeBinaryFromReader(message: SetStockLocationIsHiddenRequestProto, reader: jspb.BinaryReader): SetStockLocationIsHiddenRequestProto;
}

export namespace SetStockLocationIsHiddenRequestProto {
    export type AsObject = {
        tenantId: string,
        stockLocationId: string,
        hide: boolean,
...
export class SetStockLocationIsHiddenResponseProto extends jspb.Message { 

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): SetStockLocationIsHiddenResponseProto.AsObject;
    static toObject(includeInstance: boolean, msg: SetStockLocationIsHiddenResponseProto): SetStockLocationIsHiddenResponseProto.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: SetStockLocationIsHiddenResponseProto, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): SetStockLocationIsHiddenResponseProto;
    static deserializeBinaryFromReader(message: SetStockLocationIsHiddenResponseProto, reader: jspb.BinaryReader): SetStockLocationIsHiddenResponseProto;
}

export namespace SetStockLocationIsHiddenResponseProto {
    export type AsObject = {
    }
}
