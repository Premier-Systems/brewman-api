...
goog.exportSymbol('proto.bmapi.stocks.stockgroup.GetStockGroupsRequestProto', null, global);
goog.exportSymbol('proto.bmapi.stocks.stockgroup.GetStockGroupsResponseProto', null, global);
 ...
 * @constructor
 */
proto.bmapi.stocks.stockgroup.GetStockGroupsRequestProto = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.bmapi.stocks.stockgroup.GetStockGroupsRequestProto.repeatedFields_, null);
};
goog.inherits(proto.bmapi.stocks.stockgroup.GetStockGroupsRequestProto, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.bmapi.stocks.stockgroup.GetStockGroupsRequestProto.displayName = 'proto.bmapi.stocks.stockgroup.GetStockGroupsRequestProto';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.bmapi.stocks.stockgroup.GetStockGroupsResponseProto = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.bmapi.stocks.stockgroup.GetStockGroupsResponseProto.repeatedFields_, null);
};
goog.inherits(proto.bmapi.stocks.stockgroup.GetStockGroupsResponseProto, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.bmapi.stocks.stockgroup.GetStockGroupsResponseProto.displayName = 'proto.bmapi.stocks.stockgroup.GetStockGroupsResponseProto';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.bmapi.stocks.stockgroup.GetStockGroupsRequestProto.repeatedFields_ = [2];
 ...
 * @return {!Object}
 */
proto.bmapi.stocks.stockgroup.GetStockGroupsRequestProto.prototype.toObject = function(opt_includeInstance) {
  return proto.bmapi.stocks.stockgroup.GetStockGroupsRequestProto.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.bmapi.stocks.stockgroup.GetStockGroupsRequestProto} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bmapi.stocks.stockgroup.GetStockGroupsRequestProto.toObject = function(includeInstance, msg) {
  var f, obj = {
    tenantId: jspb.Message.getFieldWithDefault(msg, 1, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.bmapi.stocks.stockgroup.GetStockGroupsRequestProto}
 */
proto.bmapi.stocks.stockgroup.GetStockGroupsRequestProto.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.bmapi.stocks.stockgroup.GetStockGroupsRequestProto;
  return proto.bmapi.stocks.stockgroup.GetStockGroupsRequestProto.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.bmapi.stocks.stockgroup.GetStockGroupsRequestProto} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.bmapi.stocks.stockgroup.GetStockGroupsRequestProto}
 */
proto.bmapi.stocks.stockgroup.GetStockGroupsRequestProto.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.bmapi.stocks.stockgroup.GetStockGroupsRequestProto.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.bmapi.stocks.stockgroup.GetStockGroupsRequestProto.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.bmapi.stocks.stockgroup.GetStockGroupsRequestProto} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bmapi.stocks.stockgroup.GetStockGroupsRequestProto.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getTenantId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.bmapi.stocks.stockgroup.GetStockGroupsRequestProto.prototype.getTenantId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.bmapi.stocks.stockgroup.GetStockGroupsRequestProto} returns this
 */
proto.bmapi.stocks.stockgroup.GetStockGroupsRequestProto.prototype.setTenantId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {!Array<string>}
 */
proto.bmapi.stocks.stockgroup.GetStockGroupsRequestProto.prototype.getStockGroupIdsList = function() {
 ...
 * @return {!proto.bmapi.stocks.stockgroup.GetStockGroupsRequestProto} returns this
 */
proto.bmapi.stocks.stockgroup.GetStockGroupsRequestProto.prototype.setStockGroupIdsList = function(value) {
 ...
 * @return {!proto.bmapi.stocks.stockgroup.GetStockGroupsRequestProto} returns this
 */
proto.bmapi.stocks.stockgroup.GetStockGroupsRequestProto.prototype.addStockGroupIds = function(value, opt_index) {
 ...
 * @return {!proto.bmapi.stocks.stockgroup.GetStockGroupsRequestProto} returns this
 */
proto.bmapi.stocks.stockgroup.GetStockGroupsRequestProto.prototype.clearStockGroupIdsList = function() {
 ...
 * @const
 */
proto.bmapi.stocks.stockgroup.GetStockGroupsResponseProto.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.bmapi.stocks.stockgroup.GetStockGroupsResponseProto.prototype.toObject = function(opt_includeInstance) {
  return proto.bmapi.stocks.stockgroup.GetStockGroupsResponseProto.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.bmapi.stocks.stockgroup.GetStockGroupsResponseProto} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bmapi.stocks.stockgroup.GetStockGroupsResponseProto.toObject = function(includeInstance, msg) {
  var f, obj = {
    stockGroupsList: jspb.Message.toObjectList(msg.getStockGroupsList(),
    proto.bmapi.stocks.stockgroup.StockGroupProto.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.bmapi.stocks.stockgroup.GetStockGroupsResponseProto}
 */
proto.bmapi.stocks.stockgroup.GetStockGroupsResponseProto.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.bmapi.stocks.stockgroup.GetStockGroupsResponseProto;
  return proto.bmapi.stocks.stockgroup.GetStockGroupsResponseProto.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.bmapi.stocks.stockgroup.GetStockGroupsResponseProto} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.bmapi.stocks.stockgroup.GetStockGroupsResponseProto}
 */
proto.bmapi.stocks.stockgroup.GetStockGroupsResponseProto.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.bmapi.stocks.stockgroup.GetStockGroupsResponseProto.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.bmapi.stocks.stockgroup.GetStockGroupsResponseProto.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.bmapi.stocks.stockgroup.GetStockGroupsResponseProto} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bmapi.stocks.stockgroup.GetStockGroupsResponseProto.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getStockGroupsList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
 ...
 * @return {!Array<!proto.bmapi.stocks.stockgroup.StockGroupProto>}
 */
proto.bmapi.stocks.stockgroup.GetStockGroupsResponseProto.prototype.getStockGroupsList = function() {
  return /** @type{!Array<!proto.bmapi.stocks.stockgroup.StockGroupProto>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.bmapi.stocks.stockgroup.StockGroupProto, 1));
};
...
/**
 * @param {!Array<!proto.bmapi.stocks.stockgroup.StockGroupProto>} value
 * @return {!proto.bmapi.stocks.stockgroup.GetStockGroupsResponseProto} returns this
*/
proto.bmapi.stocks.stockgroup.GetStockGroupsResponseProto.prototype.setStockGroupsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};
 ...
 * @return {!proto.bmapi.stocks.stockgroup.StockGroupProto}
 */
proto.bmapi.stocks.stockgroup.GetStockGroupsResponseProto.prototype.addStockGroups = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.bmapi.stocks.stockgroup.StockGroupProto, opt_index);
};
 ...
 * @return {!proto.bmapi.stocks.stockgroup.GetStockGroupsResponseProto} returns this
 */
proto.bmapi.stocks.stockgroup.GetStockGroupsResponseProto.prototype.clearStockGroupsList = function() {
  return this.setStockGroupsList([]);
};
