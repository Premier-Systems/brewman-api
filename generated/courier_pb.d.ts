...
export class SaveCouriersRequestProto extends jspb.Message { 
    getTenantId(): string;
    setTenantId(value: string): SaveCouriersRequestProto;
    clearCouriersList(): void;
    getCouriersList(): Array<CourierProto>;
    setCouriersList(value: Array<CourierProto>): SaveCouriersRequestProto;
    addCouriers(value?: CourierProto, index?: number): CourierProto;

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): SaveCouriersRequestProto.AsObject;
    static toObject(includeInstance: boolean, msg: SaveCouriersRequestProto): SaveCouriersRequestProto.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: SaveCouriersRequestProto, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): SaveCouriersRequestProto;
    static deserializeBinaryFromReader(message: SaveCouriersRequestProto, reader: jspb.BinaryReader): SaveCouriersRequestProto;
}

export namespace SaveCouriersRequestProto {
    export type AsObject = {
        tenantId: string,
        couriersList: Array<CourierProto.AsObject>,
    }
...
export class SaveCouriersResponseProto extends jspb.Message { 

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): SaveCouriersResponseProto.AsObject;
    static toObject(includeInstance: boolean, msg: SaveCouriersResponseProto): SaveCouriersResponseProto.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: SaveCouriersResponseProto, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): SaveCouriersResponseProto;
    static deserializeBinaryFromReader(message: SaveCouriersResponseProto, reader: jspb.BinaryReader): SaveCouriersResponseProto;
}

export namespace SaveCouriersResponseProto {
    export type AsObject = {
    }
}

export class SetCourierIsHiddenRequestProto extends jspb.Message { 
    getTenantId(): string;
    setTenantId(value: string): SetCourierIsHiddenRequestProto;
    getCourierId(): string;
    setCourierId(value: string): SetCourierIsHiddenRequestProto;
    getHide(): boolean;
    setHide(value: boolean): SetCourierIsHiddenRequestProto;

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): SetCourierIsHiddenRequestProto.AsObject;
    static toObject(includeInstance: boolean, msg: SetCourierIsHiddenRequestProto): SetCourierIsHiddenRequestProto.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: SetCourierIsHiddenRequestProto, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): SetCourierIsHiddenRequestProto;
    static deserializeBinaryFromReader(message: SetCourierIsHiddenRequestProto, reader: jspb.BinaryReader): SetCourierIsHiddenRequestProto;
}

export namespace SetCourierIsHiddenRequestProto {
    export type AsObject = {
        tenantId: string,
        courierId: string,
        hide: boolean,
...
export class SetCourierIsHiddenResponseProto extends jspb.Message { 

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): SetCourierIsHiddenResponseProto.AsObject;
    static toObject(includeInstance: boolean, msg: SetCourierIsHiddenResponseProto): SetCourierIsHiddenResponseProto.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: SetCourierIsHiddenResponseProto, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): SetCourierIsHiddenResponseProto;
    static deserializeBinaryFromReader(message: SetCourierIsHiddenResponseProto, reader: jspb.BinaryReader): SetCourierIsHiddenResponseProto;
}

export namespace SetCourierIsHiddenResponseProto {
    export type AsObject = {
    }
}
