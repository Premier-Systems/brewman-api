...
export class SavePackageTypeRequestProto extends jspb.Message { 
    getTenantId(): string;
    setTenantId(value: string): SavePackageTypeRequestProto;

    hasPackageType(): boolean;
    clearPackageType(): void;
    getPackageType(): PackageTypeProto | undefined;
    setPackageType(value?: PackageTypeProto): SavePackageTypeRequestProto;

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): SavePackageTypeRequestProto.AsObject;
    static toObject(includeInstance: boolean, msg: SavePackageTypeRequestProto): SavePackageTypeRequestProto.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: SavePackageTypeRequestProto, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): SavePackageTypeRequestProto;
    static deserializeBinaryFromReader(message: SavePackageTypeRequestProto, reader: jspb.BinaryReader): SavePackageTypeRequestProto;
}

export namespace SavePackageTypeRequestProto {
    export type AsObject = {
        tenantId: string,
        packageType?: PackageTypeProto.AsObject,
    }
...
export class SavePackageTypeResponseProto extends jspb.Message { 

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): SavePackageTypeResponseProto.AsObject;
    static toObject(includeInstance: boolean, msg: SavePackageTypeResponseProto): SavePackageTypeResponseProto.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: SavePackageTypeResponseProto, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): SavePackageTypeResponseProto;
    static deserializeBinaryFromReader(message: SavePackageTypeResponseProto, reader: jspb.BinaryReader): SavePackageTypeResponseProto;
}

export namespace SavePackageTypeResponseProto {
    export type AsObject = {
    }
}

export class SetPackageTypeIsHiddenRequestProto extends jspb.Message { 
    getTenantId(): string;
    setTenantId(value: string): SetPackageTypeIsHiddenRequestProto;
    getPackageTypeId(): string;
    setPackageTypeId(value: string): SetPackageTypeIsHiddenRequestProto;
    getHide(): boolean;
    setHide(value: boolean): SetPackageTypeIsHiddenRequestProto;

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): SetPackageTypeIsHiddenRequestProto.AsObject;
    static toObject(includeInstance: boolean, msg: SetPackageTypeIsHiddenRequestProto): SetPackageTypeIsHiddenRequestProto.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: SetPackageTypeIsHiddenRequestProto, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): SetPackageTypeIsHiddenRequestProto;
    static deserializeBinaryFromReader(message: SetPackageTypeIsHiddenRequestProto, reader: jspb.BinaryReader): SetPackageTypeIsHiddenRequestProto;
}

export namespace SetPackageTypeIsHiddenRequestProto {
    export type AsObject = {
        tenantId: string,
        packageTypeId: string,
        hide: boolean,
...
export class SetPackageTypeIsHiddenResponseProto extends jspb.Message { 

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): SetPackageTypeIsHiddenResponseProto.AsObject;
    static toObject(includeInstance: boolean, msg: SetPackageTypeIsHiddenResponseProto): SetPackageTypeIsHiddenResponseProto.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: SetPackageTypeIsHiddenResponseProto, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): SetPackageTypeIsHiddenResponseProto;
    static deserializeBinaryFromReader(message: SetPackageTypeIsHiddenResponseProto, reader: jspb.BinaryReader): SetPackageTypeIsHiddenResponseProto;
}

export namespace SetPackageTypeIsHiddenResponseProto {
    export type AsObject = {
    }
}
