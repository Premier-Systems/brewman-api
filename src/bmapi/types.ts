...
export interface BuildOrderHeaderRequest {
  ...
  /**
   *
   * Desired order number, or blank to suggest number likely to be allocated.
   */
  orderNumber?: string;
}

export interface BuildOrderHeaderResponse {
...
export enum EnumAlcoholType {
  ...
  TraditionalAfricanBeerFromMalt = "TraditionalAfricanBeerFromMalt",
  BeerFromMalt = "BeerFromMalt",
  TraditionalAfricanBeerNotFromMalt = "TraditionalAfricanBeerNotFromMalt",
  BeerNotFromMalt = "BeerNotFromMalt",
  Brandy = "Brandy",
